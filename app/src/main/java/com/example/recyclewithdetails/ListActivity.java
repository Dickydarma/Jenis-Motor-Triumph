...
public class ListActivity extends RecyclerView.Adapter<ListActivity.ViewHolder> {
    ...
    public ListActivity(Context mContext,ArrayList<String> mImageNames, ArrayList<String> mImages, ArrayList<String> mImageDesc , ArrayList<String> mImageDescriptionImage ) {
