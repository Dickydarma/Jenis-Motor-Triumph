...
public class GridActivity extends RecyclerView.Adapter<GridActivity.GridViewHolder> {
    ...
    public GridActivity(Context mContext,ArrayList<String> mImageNames, ArrayList<String> mImages, ArrayList<String> mImageDesc , ArrayList<String> mImageDescriptionImage ) {
